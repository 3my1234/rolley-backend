...
let AuthController = class AuthController {
    ...
    async syncUser(req, body) {
        ...
        if (!privyUserId) {
            throw new common_1.UnauthorizedException('Privy user id not found in token claims');
        }
        const user = await this.authService.syncUser(privyUserId, body.referralCode);
        return {
            user,
            synced: true,
        };
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Sync user from Privy to database' }),
